...
" autocomplétion basée sur le langage du fichier en cours d'édition (ne
" marche pas forcément bien, dépend de la version de vim)
...
set showcmd
" lorsque le curseur est sur un symbole marquant la fin ou le début d'un
" 'bloc' (typiquement une parenthèse, un crochet ou une accolade) cette
" option met aussi en surbrillance le symbole correspondant
set showmatch
